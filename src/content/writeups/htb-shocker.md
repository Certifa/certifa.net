...
title: "Shocker"
date: 2026-07-01
tags: [linux, web, cgi, shellshock, cve-2014-6271, sudo, gtfobins, privesc]
difficulty: easy
platform: HTB
description: "A CGI shell script backed by a vulnerable Bash lets a crafted HTTP header trigger Shellshock (CVE-2014-6271) for RCE. Privesc via a passwordless sudo rule on perl, one GTFOBins command to root."
featured: true
---
...
![Shocker index page](/images/writeups/shocker/image.png)
...
![Reverse shell as shelly](/images/writeups/shocker/image1.png)
...
![Root shell](/images/writeups/shocker/image2.png)

`root.txt` is in `/root`.

![Root flag](/images/writeups/shocker/image-3.png)
